...
export default function InvitedWorkspace() {
    ...
    return (
        <div className="flex-1">
            <h3 className="text-slate-700 font-semibold text-xl">Invitados ({workspace.members?.length})</h3>
            ...
            {workspace.members && workspace.members.length > 0 ? (
                <div>
                    <div className="py-6 border-t border-t-gray-300">
                        <h3 className="text-slate-700 font-semibold text-xl">Invitados a tableros del Espacio de trabajo ({workspace.members?.length})</h3>
